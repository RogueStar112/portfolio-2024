  ...
  return (
    <html className="scroll-smooth w-full relative overflow-x-hidden" lang="en" suppressHydrationWarning>
      ...
      <body className={`${montserrat.className} !dark:font-sans !dark:font-white /max-w-5xl /mx-auto blur-none bg-transparent dark:bg-onyx dark:*:bg-onyx dark:duration-500 relative z-999`}>
        <div className='absolute inset-0 h-full w-full bg-transparent bg-[radial-gradient(#cccccc_1px,transparent_1px)] dark:bg-[radial-gradient(#000000_1px,transparent_1px)] bg-size-[36px_36px] select-none z-0'></div>

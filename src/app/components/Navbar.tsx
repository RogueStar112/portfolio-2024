...
export default function NavBar() {
  ...
  return (
    <header className={`grid grid-cols-2 justify-between relative sticky from-white dark:from-onyx ${showMobileNav ? `bg-linear-to-b from-90%` : `bg-linear-to-b from-33%`} to-transparent top-0 bg-inherit z-50 py-2 max-w-7xl mx-auto`}>

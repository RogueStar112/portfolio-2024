...
export default function MainContent({content}: any) {
  ...
  return (
   <div className='p-4 bg-transparent dark:bg-transparent h-full dark:text-mint-cream mx-auto text-current /max-w-7xl relative col-start-2'>

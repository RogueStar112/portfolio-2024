...
export default function Blog(blog: any) {
  ...
  return (
    ...
    <article key={blog.id} id={blog.id} className={`col-span-1 border-2 border-blue-200 dark:border-orange-500 overflow-hidden rounded-lg /max-w-[100%] /md:max-w-[33.3%] grid grid-cols-[80px_1fr] md:flex md:flex-col justify-start content-end ${isLastElement ? "col-span-full" : ""}`}>
